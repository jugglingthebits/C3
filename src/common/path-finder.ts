...
export class PerpendicularPathFinder implements PathFinder {
    ...
    findShortestPath(sourceConnectionPoints: Point[],
        ...
        const shortestPath = connectionPointCombinations.reduce((previousShortestPath, currentConnectionPoints) => {
            const currentShortestPath = this.findShortestConnectionPath(currentConnectionPoints[0], currentConnectionPoints[1]);
    ...
    private findShortestConnectionPath(sourcePoint: Point, targetPoint: Point): Point[] {
